...
```tsx {3} title="layout.tsx" caption="Like a poor star, that's why, the bug, left behind." showLineNumbers /className/ /fontMono/#v /fontSans/#s /fontSerif/#i
...
![Chunsik](https://images.pexels.com/photos/262508/pexels-photo-262508.jpeg?cs=srgb&dl=pexels-pixabay-262508.jpg&fm=jpg)_\!\[Image Description\](Link)_
