...
// 3. 변환, creating code blocks and fragments
...
AST에서 **컴포넌트의 다양한 동작을 수행하기 위한 정보를 추출**합니다.
참고로 하나의 Svelte 파일이 곧 하나의 컴포넌트입니다.

컴포넌트가 갖는 주요 속성을 정리하면 아래와 같습니다. [원본 코드 참고](https://github.com/sveltejs/svelte/blob/b8f3c49e5ff7378df2196d0c9ae24a58e282bb0a/packages/svelte/src/compiler/phases/2-analyze/index.js#L328)
...
- module: 컴포넌트 간에 공유되는 상태와 로직을 정의합니다. `<script context="module">`로 정의를 하죠.
- instance: 컴포넌트의 고유 상태와 로직을 정의합니다. 일반적으로 코드를 작성하는 방식
