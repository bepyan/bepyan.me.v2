...
또한, JavaScript로 작성된 외부 라이브러리에 타입 정보를 보완하기 위해 직접 `.d.ts` 파일을 작성하거나, [DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped)와 같은 저장소에서 제공하는 타입 정의를 사용할 수 있습니다. 예를 들어, jQuery의 타입 정보를 유용하게 사용할 수 있을 것 같네요.
...
`typescript-eslint`의 recommended rules로 no-namespace가 있습니다.
