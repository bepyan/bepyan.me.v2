...
Astro의 가장 큰 매력 중 하나는 React, Vue, Svelte, Solid 등 여러 웹 프레임워크를 사용할 수 있다는 점입니다. NextJS는 React만을 써야 하고 Nuxt는 Vue만을 써야 하기 때문이죠. 이러한 다양성은 프로젝트의 유연성을 향상할 수 있지만 다른 프레임워크간 같은 상태를 공유하는 새로운 도전 과제를 던져줍니다.
