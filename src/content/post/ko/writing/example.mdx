...
```ts caption="긴 코드는 가로로 스크롤됩니다. 스크롤해도 복사 버튼과 언어 라벨은 우측 상단에 고정됩니다."
const url = `https://api.example.com/v1/posts?category=engineering&sort=created_at&order=desc&page=1&limit=50&fields=title,description,tags,author,publishedAt`;
