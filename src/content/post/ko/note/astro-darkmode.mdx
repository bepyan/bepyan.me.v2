...
또한 Astro의 또 한가지 고유 문법 [**Script & Style Directives**](https://docs.astro.build/en/reference/directives-reference/#script--style-directives)도 주의해야 합니다.
...
```astro title="theme-head-script.astro" /is:inline/#v
---
const theme = 'dark';
---
