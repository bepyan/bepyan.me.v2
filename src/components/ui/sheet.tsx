...
const sheetVariants = cva(
  'bg-white dark:bg-gray-950 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn(
      'text-gray-950 text-lg font-semibold dark:text-gray-50',
      className,
    )}
    {...props}
  />
